# when computing accuracy, only consider those who are currently updated/labeled
# first when set t = 1, reduced to 2-hop MV

def iterative_method_test_new(t, G, gender_y_update, theta0, train_index, test_index, bench_mark):
